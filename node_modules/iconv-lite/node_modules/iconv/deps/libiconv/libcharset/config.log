...
generated by GNU Autoconf 2.68.  Invocation command line was
  ...
  $ ./configure --disable-option-checking --prefix=/usr/local --disable-shared --enable-static --enable-relocatable --enable-extra-encodings --cache-file=/dev/null --srcdir=.
...
configure:3248: result: i686-pc-linux-gnu
configure:3268: checking host system type
configure:3281: result: i686-pc-linux-gnu
...
configure:4467: checking how to convert i686-pc-linux-gnu file names to i686-pc-linux-gnu format
configure:4507: result: func_convert_file_noop
configure:4514: checking how to convert i686-pc-linux-gnu file names to toolchain format
...
configure:5493: found /bin/gawk
configure:5504: result: gawk
...
configure:6140: checking if : is a manifest tool
configure:6146: : '-?'
...
configure:8156: checking whether the gcc linker (/usr/bin/ld) supports shared libraries
...
config.status:1077: creating include/localcharset.h
config.status:1077: creating include/localcharset.h.inst
...
LD='/usr/bin/ld'
LDFLAGS=''
LIBOBJS=' ${LIBOBJDIR}relocatable$U.o'
LIBS=''
LIBTOOL='/bin/sh $(top_builddir)/libtool'
LIPO=''
LN_S='ln -s'
LTLIBOBJS=' ${LIBOBJDIR}relocatable$U.lo'
MANIFEST_TOOL=':'
NM='/usr/bin/nm -B'
NMEDIT=''
OBJDUMP='objdump'
